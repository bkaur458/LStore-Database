...
class Query:
    ...
    def delete(self, primary_key):
        ...
        # value = curr_page.data[base_slot*8 : (base_slot*8+8)]
        # self.table.index.delete(rid, value, 0)
        '''
        ...
        #self.table.bufferpool.merge_write(curr_page)
        #self.table.bufferpool.mark_page_dirty(page_id)
